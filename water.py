...
def DWT(coverImage, watermarkImage):
    ...
    cv2.imshow('Watermarked Image', watermarkedImage)
    cv2.imwrite('C:\\Users\\AMIRTH\\Desktop\\DWT-DCT-SVD-MASTER\\result\\'+'watermarkedImage.jpg',watermarkedImage)
    #Extraction
...
def DCT(coverImage, watermarkImage):
    ...
    watermarkedImage = np.uint8(watermarkedImage)
    cv2.imshow('watermarked',watermarkedImage)
...
if __name__ == "__main__":
    ...
    coverImage = cv2.imread('C:\\Users\\AMIRTH\\Desktop\\DWT-DCT-SVD-MASTER\\pictures\\'+image_name,0)
    watermarkImage = cv2.imread('C:\\Users\\AMIRTH\\Desktop\\DWT-DCT-SVD-MASTER\\pictures\\'+water_image,0)
    ...
    options[int(val)](coverImage,watermarkImage)
